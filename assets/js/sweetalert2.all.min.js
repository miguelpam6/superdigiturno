    ...
    193: function(t, e, n) {
        t.exports = function() {
            ...
            const t = Object.freeze({
              ...
              , N = (t,e,i)=>{
                ...
                e.customClass && e.customClass[i]) {
                    if ("string" != typeof e.customClass[i] && !e.customClass[i].forEach)
                        return o("Invalid type of customClass.".concat(i, '! Expected string or iterable object, got "').concat(typeof e.customClass[i], '"'));
                    _(t, e.customClass[i])
                }
            }
              , U = (t,e)=>{
              ...
              , it = t=>{
                const e = (()=>{
                    const t = h();
                    return !!t && (t.remove(),
                    z([document.documentElement, document.body], [m["no-backdrop"], m["toast-shown"], m["has-column"]]),
                    !0)
                }
                )();
                if (et())
              ...
              , lt = (t,e)=>{
                ...
                e.reverseButtons && (n.insertBefore(r, o),
                n.insertBefore(s, o),
                n.insertBefore(i, o)),
                q(o, e.loaderHtml),
                N(o, e, "loader")
            ...
            const dt = (t,e)=>{
                ...
                function(t, e) {
                    e in m ? _(t, m[e]) : (o('The "position" parameter is not valid, defaulting to "center"'),
                    _(t, m.center))
                }(n, e.position),
                function(t, e) {
            ...
            const mt = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
              , gt = t=>{
                if (!vt[t.input])
                    return i('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(t.input, '"'));
                const e = wt(t.input)
                  , n = vt[t.input](e, t);
                Y(n),
                setTimeout(()=>{
              ...
              , vt = {};
            vt.text = vt.email = vt.password = vt.number = vt.tel = vt.url = (t,e)=>("string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : u(e.inputValue) || o('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof e.inputValue, '"')),
            yt(t, t, e),
            bt(t, e),
            t.type = e.input,
            t),
            vt.file = (t,e)=>(yt(t, t, e),
            bt(t, e),
            t),
            vt.range = (t,e)=>{
            ...
            ,
            vt.textarea = (t,e)=>(t.value = e.inputValue,
            bt(t, e),
            yt(t, t, e),
            setTimeout(()=>{
            ...
            const Ct = (t,e)=>{
              ...
              , Et = (t,e)=>{
                ...
                Y(n),
                n.textContent = "",
                e.currentProgressStep >= e.progressSteps.length && o("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
                e.progressSteps.forEach((t,o)=>{
                    const i = (t=>{
                        const e = document.createElement("li");
                        return _(e, m["progress-step"]),
                        q(e, t),
                        e
                    }
                    )(t);
                    if (n.appendChild(i),
                    o === e.currentProgressStep && _(i, m["active-progress-step"]),
                    o !== e.progressSteps.length - 1) {
                        const t = (t=>{
                            const e = document.createElement("li");
                            return _(e, m["progress-step-line"]),
              ...
              , St = (t,e)=>{
                t.className = "".concat(m.popup, " ").concat($(t) ? e.showClass.popup : ""),
                e.toast ? (_([document.documentElement, document.body], m["toast-shown"]),
                _(t, m.toast)) : _(t, m.modal),
                N(t, e, "popup"),
              ...
              , Ot = (t,e)=>{
                ((t,e)=>{
                    const n = h()
                      , o = y();
                    e.toast ? (K(n, "width", e.width),
                    o.style.width = "100%",
                    o.insertBefore(E(), w())) : K(o, "width", e.width),
                ...
                ((t,e)=>{
                    const n = pt.innerParams.get(t)
                      , o = w();
                    n && e.icon === n.icon ? (Bt(o, e),
                    kt(o, e)) : e.icon || e.iconHtml ? e.icon && -1 === Object.keys(g).indexOf(e.icon) ? (i('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')),
                    Z(o)) : (Y(o),
                    Bt(o, e),
                    kt(o, e),
                    _(o, e.showClass.icon)) : Z(o)
                }
                )(t, e),
                ((t,e)=>{
                    const n = k();
            ...
            var Jt = Object.freeze({
                ...
                bindClickHandler: function(t="data-swal-template") {
                    Vt[t] = this,
                    qt || (document.body.addEventListener("click", Nt),
                    qt = !0)
                }
            });
            function Xt() {
            ...
            function se(t, e, o, i) {
                ...
                D() && (null !== H.previousBodyPadding && (document.body.style.paddingRight = "".concat(H.previousBodyPadding, "px"),
            ...
            const ae = t=>void 0 === t ? {
              ...
              , ce = (t,e,n)=>{
                ...
                i ? le(t, e, o, n.returnFocus, n.didClose) : se(t, o, n.returnFocus, n.didClose)
            }
              , le = (t,e,n,o,i)=>{
                Mt.swalCloseEventFinishedCallback = se.bind(null, t, n, o, i),
                e.addEventListener(ct, (function(t) {
                    t.target === e && (Mt.swalCloseEventFinishedCallback(),
            ...
            function he(t) {
                ...
                t.showLoaderOnConfirm && !t.preConfirm && o("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"),
                function(t) {
                    (!t.target || "string" == typeof t.target && !document.querySelector(t.target) || "string" != typeof t.target && !t.target.appendChild) && (o('Target parameter is not valid, defaulting to "body"'),
                    t.target = "body")
                }(t),
            ...
            const fe = ["swal-title", "swal-html", "swal-footer"]
              ...
              , ye = t=>{
                ...
                return n(t.querySelectorAll("swal-button")).forEach(t=>{
                    ...
                    t.hasAttribute("color") && (o["".concat(n, "ButtonColor")] = t.getAttribute("color")),
                    t.hasAttribute("aria-label") && (o["".concat(n, "ButtonAriaLabel")] = t.getAttribute("aria-label"))
                }
                ),
                o
            }
              , we = t=>{
                ...
                return n && (Be(n, ["src", "width", "height", "alt"]),
              ...
              , Ce = t=>{
                ...
                o && (Be(o, ["type", "label", "placeholder", "value"]),
                e.input = o.getAttribute("type") || "text",
                o.hasAttribute("label") && (e.inputLabel = o.getAttribute("label")),
                o.hasAttribute("placeholder") && (e.inputPlaceholder = o.getAttribute("placeholder")),
                o.hasAttribute("value") && (e.inputValue = o.getAttribute("value")));
                const i = t.querySelectorAll("swal-input-option");
                return i.length && (e.inputOptions = {},
                n(i).forEach(t=>{
                    Be(t, ["value"]);
              ...
              , xe = t=>{
                ...
                , 10),
                D() && (Se(e, t.scrollbarPadding, i),
                n(document.body.children).forEach(t=>{
                    t === h() || t.contains(h()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden")),
                    t.setAttribute("aria-hidden", "true"))
                }
                )),
                I() || Mt.previousActiveElement || (Mt.previousActiveElement = document.activeElement),
              ...
              , Pe = t=>{
                ...
                if (t.target !== e)
                    return;
                const n = h();
                e.removeEventListener(ct, Pe),
                n.style.overflowY = "auto"
            }
              , Ee = (t,e)=>{
                ct && Q(e) ? (t.style.overflowY = "hidden",
                e.addEventListener(ct, Pe)) : t.style.overflowY = "auto"
            }
              , Se = (t,e,n)=>{
                (()=>{
              ...
              , Oe = (t,e,n)=>{
                ...
                Y(e, "grid"),
                setTimeout(()=>{
                    _(e, n.showClass.popup),
                    e.style.removeProperty("opacity")
                }
                , 10),
                _([document.documentElement, document.body], m.shown),
                n.heightAuto && n.backdrop && !n.toast && _([document.documentElement, document.body], m["height-auto"])
            }
              , Te = t=>t.checked ? 1 : 0
              ...
              , Me = (t,e)=>{
                ...
                c(e.inputOptions) || u(e.inputOptions) ? (Lt(x()),
              ...
              , Ve = (t,e,n)=>{
                ...
                e.inputValidator ? Ne(t, e, o, n) : t.getInput().checkValidity() ? "deny" === n ? Ue(t, e, o) : Re(t, e, o) : (t.enableButtons(),
                t.showValidationMessage(e.validationMessage))
            }
              , Ne = (t,e,n,o)=>{
                t.disableInput(),
                Promise.resolve().then(()=>l(e.inputValidator(n, e.validationMessage))).then(i=>{
                    t.enableButtons(),
                    t.enableInput(),
                    i ? t.showValidationMessage(i) : "deny" === o ? Ue(t, e, n) : Re(t, e, n)
                }
                )
            }
              , Ue = (t,e,n)=>{
                e.showLoaderOnDeny && Lt(P()),
                e.preDeny ? Promise.resolve().then(()=>l(e.preDeny(n, e.validationMessage))).then(e=>{
              ...
              , Re = (t,e,n)=>{
                ...
                Promise.resolve().then(()=>l(e.preConfirm(n, e.validationMessage))).then(e=>{
              ...
              , Ke = (t,e,n)=>{
                ...
                "Enter" === e.key ? Ye(t, e, o) : "Tab" === e.key ? Ze(e, o) : [...ze, ...We].includes(e.key) ? Je(e.key) : "Escape" === e.key && Xe(e, o, n))
            }
              , Ye = (t,e,n)=>{
              ...
              , Je = t=>{
                if (![x(), P(), S()].includes(document.activeElement))
                    return;
              ...
              , Xe = (e,n,o)=>{
                a(n.allowEscapeKey) && (e.preventDefault(),
                o(t.esc))
            }
              , $e = (e,n,o)=>{
                n.popup.onclick = ()=>{
            ...
            const Qe = t=>{
              ...
              , tn = t=>{
                t.container.onmousedown = ()=>{
                    t.popup.onmouseup = function(e) {
                        ...
                        (e.target === t.popup || t.popup.contains(e.target)) && (Ge = !0)
                    }
                }
            }
              , en = (e,n,o)=>{
              ...
              , on = (e,n,o)=>new Promise(i=>{
                ...
                n.confirmButton.onclick = ()=>((t,e)=>{
                    t.disableButtons(),
                    e.input ? Ve(t, e, "confirm") : Re(t, e, !0)
                }
                )(e, o),
                n.denyButton.onclick = ()=>((t,e)=>{
                    t.disableButtons(),
                    e.returnInputValueOnDeny ? Ve(t, e, "deny") : Ue(t, e, !1)
                }
                )(e, o),
                n.cancelButton.onclick = ()=>((e,n)=>{
                    e.disableButtons(),
                    n(t.cancel)
                }
                )(e, s),
                ...
                ((t,e,n)=>{
                    pt.innerParams.get(t).toast ? $e(t, e, n) : (Qe(e),
                    tn(e),
                    en(t, e, n))
                }
                )(e, n, s),
                ((t,e,n,o)=>{
                    ...
                    n.toast || (e.keydownHandler = e=>Ke(t, e, o),
                ...
                ((t,e)=>{
                    "select" === e.input || "radio" === e.input ? Me(t, e) : ["text", "email", "number", "tel", "textarea"].includes(e.input) && (c(e.inputValue) || u(e.inputValue)) && (Lt(x()),
                    De(t, e))
                }
                )(e, o),
                xe(o),
              ...
              , rn = (t,e,n)=>{
                const o = L();
                Z(o),
                e.timer && (t.timeout = new me(()=>{
                    n("timer"),
                    delete t.timeout
                }
                ,e.timer),
                e.timerProgressBar && (Y(o),
                setTimeout(()=>{
              ...
              , an = (t,e)=>{
                if (!e.toast)
                    return a(e.allowEnterKey) ? void (cn(t, e) || _e(0, -1, 1)) : ln()
            }
              , cn = (t,e)=>e.focusDeny && $(t.denyButton) ? (t.denyButton.focus(),
            !0) : e.focusCancel && $(t.cancelButton) ? (t.cancelButton.focus(),
            !0) : !(!e.focusConfirm || !$(t.confirmButton) || (t.confirmButton.focus(),
            0))
              , ln = ()=>{
            ...
            var pn = Object.freeze({
                ...
                showValidationMessage: function(t) {
                    ...
                    n.customClass && n.customClass.validationMessage && _(e.validationMessage, n.customClass.validationMessage),
                ...
                _destroy: function() {
                    ...
                    e && (t.popup && Mt.swalCloseEventFinishedCallback && (Mt.swalCloseEventFinishedCallback(),
                    delete Mt.swalCloseEventFinishedCallback),
                    Mt.deferDisposalTimer && (clearTimeout(Mt.deferDisposalTimer),
